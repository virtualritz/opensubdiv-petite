...
extern "C"
{
    ...
    CudaVertexBuffer *
    CudaVertexBuffer_Create(int numElements, int numVertices, void *deviceContext)
    {
        return OpenSubdiv::Osd::CudaVertexBuffer::Create(
            numElements, numVertices, deviceContext);
    }

    /// Destructor.
    void CudaVertexBuffer_destroy(CudaVertexBuffer *vb)
    {
        delete vb;
    }
    ...
    void CudaVertexBuffer_UpdateData(
        CudaVertexBuffer *vb,
        const float *src,
        int startVertex,
        int numVertices,
