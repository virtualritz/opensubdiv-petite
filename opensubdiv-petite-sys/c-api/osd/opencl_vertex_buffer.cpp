...
extern "C"
{
    ...
    CLVertexBuffer *
    CLVertexBuffer_Create(int numElements, int numVertices, void *clContext)
    {
        return OpenSubdiv::Osd::CLVertexBuffer::Create(
            numElements, numVertices, clContext);
    }

    /// Destructor.
    void CLVertexBuffer_destroy(CLVertexBuffer *vb)
    {
        delete vb;
    }
    ...
    void CLVertexBuffer_UpdateData(
        CLVertexBuffer *vb,
        const float *src,
        int startVertex,
        int numVertices,
...
extern "C"
{
    CLVertexBuffer *CLVertexBuffer_Create(int, int, void *)
    {
        return nullptr;
    }
    ...
    int CLVertexBuffer_GetNumElements(CLVertexBuffer *)
    {
        return 0;
    }
    int CLVertexBuffer_GetNumVertices(CLVertexBuffer *)
    {
        return 0;
    }
    void *CLVertexBuffer_BindCLBuffer(CLVertexBuffer *, void *)
    {
        return nullptr;
    }
}
