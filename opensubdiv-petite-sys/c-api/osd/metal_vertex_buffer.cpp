...
MTLVertexBuffer* MTLVertexBuffer_Create(int numElements, int numVertices,
                                        void* device) {
    return OpenSubdiv::Osd::MTLVertexBuffer::Create(numElements, numVertices,
                                                    device);
}

/// Destructor.
void MTLVertexBuffer_destroy(MTLVertexBuffer* vb) { delete vb; }

/// This method is meant to be used in client code in order to provide
/// coarse vertices data to Osd.
void MTLVertexBuffer_UpdateData(MTLVertexBuffer* vb, const float* src,
