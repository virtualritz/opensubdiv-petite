...
extern "C"
{
    ...
    const OpenSubdiv::Far::StencilTable *
    PatchTable_GetLocalPointStencilTable(const PatchTable *table)
    {
    ...
    void PatchTable_GetPatchArrayDescriptor(
        const PatchTable *table, int arrayIndex, PatchDescriptor *desc)
    {
    ...
    void PatchTable_GetPatchParam(
        const PatchTable *table, int arrayIndex, int patchIndex, PatchParam *param)
    {
        if (!param)
            return;
    ...
    void PatchTableFactory_Options_SetTriangleSubdivision(
        Options * /*options*/, int /*triangleSubdivision*/)
    {
        // Triangle subdivision is set through scheme type, not a separate option
        // This is a no-op for compatibility
    }

    void PatchTableFactory_Options_SetUseInfSharpPatch(
        Options *options, bool useInfSharpPatch)
    {
        options->useInfSharpPatch = useInfSharpPatch;
    }

    void PatchTableFactory_Options_SetNumLegacyGregoryPatches(
        Options * /*options*/, int /*numPatches*/)
    {
