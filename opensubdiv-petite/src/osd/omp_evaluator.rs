...
/// Evaluate stencils using OpenMP for CPU parallelism.
///
/// This is a drop-in replacement for
/// [`super::cpu_evaluator::evaluate_stencils`] that uses OpenMP `parallel for`
...
pub fn evaluate_stencils(
    ...
    unsafe {
        if sys::osd::OmpEvaluator_EvalStencils(
            src_buffer.0,
            src_desc.0,
            dst_buffer.0,
            dst_desc.0,
