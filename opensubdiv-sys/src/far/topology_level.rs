...
extern "C" {
    ...
    //@{
    /// @name Methods to inspect topological relationships for individual
    /// components:
    ///
    ...
    /// \brief Access the local indices of a vertex with respect to its incident
    /// faces
    ...
    /// \brief Access the local indices of an edge with respect to its incident
    /// faces
    ...
    //@{
    /// @name Methods to inspect other topological properties of individual
    /// components:
    ...
    /// \brief Return the number of face-varying channels (should be same for
    /// all levels)
    pub fn TopologyLevel_GetNumFVarChannels(tl: TopologyLevelPtr) -> i32;

    /// \brief Return the total number of face-varying values in a particular
    ...
    //@{
    /// @name Methods to identify parent or child components in adjoining levels
    /// of refinement:
